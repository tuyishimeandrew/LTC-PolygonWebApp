...
# Inform the user if no main file is provided
if main_file is None:
    st.info("Please upload the Main Inspection Form file to proceed.")

# Process only if the main file is provided
if main_file is not None:
    # --- PROCESS MAIN INSPECTION FORM ---
    try:
        ...
        # Check required columns in the main form
        if 'Farmercode' not in df.columns or 'polygonplot' not in df.columns:
            ...
            # --- PROCESS OPTIONAL REDO POLYGON FORM ---
            if redo_file is not None:
                try:
                    ...
                    if not all(col in df_redo.columns for col in required_redo_cols):
                        ...
                        # --- Apply Conditions ---
                        # Condition 1: If main form's polygonplot is not null and redo_selectplot is Plot1, update polygonplot.
                        cond1 = df['polygonplot'].notna() & (df['redo_selectplot'] == 'Plot1')
                        df.loc[cond1, 'polygonplot'] = df.loc[cond1, 'redo_polygonplot']
                        
                        # Condition 2: If polygonplotnew_1 is not null and redo_selectplot is Plot2, update polygonplot.
                        ...
                        # Condition 3: If polygonplotnew_2 is not null and redo_selectplot is Plot3, update polygonplotnew_2.
                        ...
                        # Condition 4: If polygonplotnew_3 is not null and redo_selectplot is Plot4, update polygonplotnew_3.
                        ...
                        # Condition 5: If polygonplotnew_4 is not null and redo_selectplot is Plot5, update polygonplotnew_4.
                        ...
                        # Optionally drop the redo columns
            ...
            if not farmer_codes:
                ...
                if not target_row.empty:
                    ...
                    target_area_acres = target_area_m2 * 0.000247105  # Conversion factor
